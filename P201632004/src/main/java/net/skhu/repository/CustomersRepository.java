...
public interface CustomersRepository extends JpaRepository<Customers,Integer>{
	...
	public Page<Customers> findByLastName(String lastName,Pageable pageable);
	public Page<Customers> findByEmailAddress(String emailAddress,Pageable pageable);
	public Page<Customers> findByJobTitle(String jobTitle, Pageable pageable);
}
